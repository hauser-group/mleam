...
class SMATBTest(ModelTest.ModelTest):
    ...
    def get_random_model(self, atom_types=["Ni", "Pt"], **kwargs):
        ...
        model = self.model_class(
            atom_types, params=initial_params, build_forces=True, **kwargs
        )
...
class NNEmbeddingModelTest(ModelTest.ModelTest):
    def get_model(self, atom_types=["Ni", "Pt"], **kwargs):
        return NNEmbeddingModel(
            atom_types,
            params={("F_layers", "Ni"): [12, 8], ("F_layers", "Pt"): [6, 8, 4]},
            build_forces=True,
            **kwargs,
        )
    ...
    def get_random_model(self, atom_types=["Ni", "Pt"], **kwargs):
        ...
        model = NNEmbeddingModel(atom_types, params=params, build_forces=True, **kwargs)
...
class NNRhoModelTest(ModelTest.ModelTest):
    ...
    def get_random_model(self, atom_types=["Ni", "Pt"], **kwargs):
        ...
        model = NNRhoModel(atom_types, params=params, build_forces=True, **kwargs)
...
class NNRhoExpModelTest(ModelTest.ModelTest):
    ...
    def get_random_model(self, atom_types=["Ni", "Pt"], **kwargs):
        ...
        model = NNRhoExpModel(atom_types, params=params, build_forces=True, **kwargs)
...
class NNEmbeddingNNRhoModelTest(ModelTest.ModelTest):
    ...
    def get_random_model(self, atom_types=["Ni", "Pt"], **kwargs):
        ...
        model = self.model_class(atom_types, params=params, build_forces=True, **kwargs)
...
class CommonNNEmbeddingModelTest(ModelTest.ModelTest):
    ...
    def get_random_model(self, atom_types=["Ni", "Pt"], **kwargs):
        ...
        model = CommonNNEmbeddingModel(
            atom_types, params=params, build_forces=True, **kwargs
        )
...
class CommonNNEmbeddingNNRhoModelTest(ModelTest.ModelTest):
    ...
    def get_random_model(self, atom_types=["Ni", "Pt"], **kwargs):
        ...
        model = CommonNNEmbeddingNNRhoModel(
            atom_types, params=params, build_forces=True, **kwargs
        )
